<?php
namespace Drupal\mongodb_api\adddocumentForm;
 ...
 //  $modal_form = \Drupal::formBuilder()->getForm('add_collection');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
		 ...
		 $updateWith = substr($updateWith,0, strlen($updateWith)-1) . "}";		 
		  ...
		  $api_endpointurl = "ec2-54-210-86-147.compute-1.amazonaws.com:3000/api/collections/" . $_GET['mongodb_collection'] ."/insert";
